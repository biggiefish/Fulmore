...
## Define and Load Input Files
  #1. PacFish Temp and Flow Data
    catch_dat <- "Data/RST Catch/RST_Catch_2024.04.24.xlsx"
...
```{r SK_FL, echo = FALSE, warning = FALSE, fig.cap = "Length-frequency distribution for Sockeye Salmon captured in the Fulmore River.", message = FALSE, out.width= "2000px"}
#, out.height="1200px"
## Prepare Plots ----
