...
The length-frequency distribution for Sockeye Salmon smolts is bimodal, suggesting two groups of different sized fish are emigrating simultaneously. Scale aging will be required to assess what is contributing to this observed difference. However, it is likely be explained by: 
